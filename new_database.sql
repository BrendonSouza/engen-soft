...
-- object: public.condicoes | type: TABLE --
...
-- ALTER TABLE public.condicoes DROP CONSTRAINT IF EXISTS requisitos_funcionais_fk CASCADE;
ALTER TABLE public.condicoes ADD CONSTRAINT requisitos_funcionais_fk FOREIGN KEY (id_requisitos_funcionais)
